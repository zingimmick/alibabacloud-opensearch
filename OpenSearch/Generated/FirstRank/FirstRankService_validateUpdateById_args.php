...
class FirstRankService_validateUpdateById_args
{
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'identity', 'type' => \Thrift\Type\TType::STRING), 2 => array('var' => 'firstRank', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\OpenSearch\Generated\FirstRank\FirstRank'));
        }
        if (is_array($vals)) {
    ...
    public function write($output)
    {
        ...
        if ($this->firstRank !== null) {
            ...
            $xfer += $output->writeFieldBegin('firstRank', \Thrift\Type\TType::STRUCT, 2);
