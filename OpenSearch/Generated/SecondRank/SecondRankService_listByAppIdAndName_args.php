...
class SecondRankService_listByAppIdAndName_args
{
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'appId', 'type' => \Thrift\Type\TType::STRING), 2 => array('var' => 'name', 'type' => \Thrift\Type\TType::STRING));
        }
        if (is_array($vals)) {
            if (isset($vals['appId'])) {
    ...
    public function write($output)
    {
        ...
        if ($this->name !== null) {
            $xfer += $output->writeFieldBegin('name', \Thrift\Type\TType::STRING, 2);
