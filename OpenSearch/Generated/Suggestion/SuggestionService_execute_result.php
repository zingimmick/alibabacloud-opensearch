...
class SuggestionService_execute_result
{
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(0 => array('var' => 'success', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\OpenSearch\Generated\GeneralSearcher\SearchResult'), 1 => array('var' => 'error', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\OpenSearch\Generated\Common\OpenSearchException'), 2 => array('var' => 'e', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\OpenSearch\Generated\Common\OpenSearchClientException'));
        }
        if (is_array($vals)) {
    ...
    public function write($output)
    {
        ...
        if ($this->success !== null) {
            ...
            $xfer += $output->writeFieldBegin('success', \Thrift\Type\TType::STRUCT, 0);
