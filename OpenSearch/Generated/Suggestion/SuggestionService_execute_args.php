...
class SuggestionService_execute_args
{
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'suggestParams', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\OpenSearch\Generated\Suggestion\SuggestParams'));
        }
        if (is_array($vals)) {
    ...
    public function write($output)
    {
        ...
        if ($this->suggestParams !== null) {
            ...
            $xfer += $output->writeFieldBegin('suggestParams', \Thrift\Type\TType::STRUCT, 1);
