...
class BehaviorCollectionService_push_result
{
    ...
    public function __construct($vals = null)
    {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(0 => array('var' => 'success', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\Generated\Common\OpenSearchResult'), 1 => array('var' => 'error', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\Generated\Common\OpenSearchException'), 2 => array('var' => 'e', 'type' => \Thrift\Type\TType::STRUCT, 'class' => '\Generated\Common\OpenSearchClientException'));
        }
        if (is_array($vals)) {
