 ...
 */
class StoredMessageProtocol extends \Thrift\Protocol\TProtocolDecorator
{
    private $fname_, $mtype_, $rseqid_;
    public function __construct(\Thrift\Protocol\TProtocol $protocol, $fname, $mtype, $rseqid)
    {
